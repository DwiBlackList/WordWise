<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium">{{ $class->class_name }}</h3>
                    <p class="mt-2">Token: {{ $class->token }}</p>
                    <p class="mt-2">User ID: {{ $class->user_id }}</p>
                    <p class="mt-2">User Name: {{ $class->user->name }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <a href="{{ route('editor' , $class->id) }}" >
                        <button id="addClassButton" class="mb-4 px-4 py-2 bg-blue-500 text-white rounded">Add Levels</button>
                    </a>
