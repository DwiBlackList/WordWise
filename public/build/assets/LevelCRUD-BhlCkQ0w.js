...
import { F as FaRegTrashCan } from "./index-CMMxcWw_.js";
...
const Table = ({ data }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "overflow-x-auto w-full" }, /* @__PURE__ */ React.createElement("table", { className: "table-auto w-full border-collapse shadow-xl" }, /* @__PURE__ */ React.createElement("thead", { className: "bg-white border-b border-gray-200" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "px-2 sm:px-4 py-2 text-left text-gray-600 w-1/3" }, "Level Name"), /* @__PURE__ */ React.createElement("th", { className: "px-2 sm:px-4 py-2 text-left text-gray-600 w-1/3" }, "Chapter Name"), /* @__PURE__ */ React.createElement("th", { className: "px-2 sm:px-4 py-2 text-center text-gray-600 w-1/6" }, "Action"))), /* @__PURE__ */ React.createElement("tbody", null, (_a2 = data == null ? void 0 : data.levelData) == null ? void 0 : _a2.map((row, _) => /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("td", { className: "px-2 sm:px-4 py-2" }, row.level_name),
    /* @__PURE__ */ React.createElement("td", { className: "px-2 sm:px-4 py-2" }, row.chapter_name),
    /* @__PURE__ */ React.createElement("td", { className: "px-2 sm:px-4 py-2 text-center" }, /* @__PURE__ */ React.createElement(
      "button",
      {
...
const TableStudents = ({ data }) => {
  ...
  reactExports.useState(null);
  console.log(data);
  return /* @__PURE__ */ React.createElement("div", { className: "overflow-x-auto w-full" }, /* @__PURE__ */ React.createElement("table", { className: "table-auto w-full border-collapse shadow-xl" }, /* @__PURE__ */ React.createElement("thead", { className: "bg-white border-b border-gray-200" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "px-2 sm:px-4 py-2 text-left text-gray-600 w-1/3" }, "Student Name"))), /* @__PURE__ */ React.createElement("tbody", null, (_a2 = data == null ? void 0 : data.studentData) == null ? void 0 : _a2.map((row, index) => /* @__PURE__ */ React.createElement("tr", { key: index, className: "bg-white hover:bg-gray-100" }, /* @__PURE__ */ React.createElement("td", { className: "px-2 sm:px-4 py-2" }, row.name))))));
};
const Page = ({ data }) => {
  const csrfTokenElement = document.querySelector('meta[name="csrf-token"]');
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col h-screen overflow-y-auto bg-gray-100 p-4" }, /* @__PURE__ */ React.createElement(ReportsComponent, { name: data.classData.class_name }), /* @__PURE__ */ React.createElement(Box, { sx: { flexGrow: 1 } }, /* @__PURE__ */ React.createElement(
    Grid2,
    {
      container: true,
  ...
  ), /* @__PURE__ */ React.createElement(Grid2, { container: true, mt: 2 }, /* @__PURE__ */ React.createElement(Grid2, { size: { xs: 12 } }, /* @__PURE__ */ React.createElement("div", { className: "p-4 bg-white rounded-xl mb-6" }, /* @__PURE__ */ React.createElement(Table, { data })), /* @__PURE__ */ React.createElement("div", { className: "p-4 bg-white rounded-xl" }, /* @__PURE__ */ React.createElement(TableStudents, { data }))))));
};
const TableCRUD = ({ ssrData: ssrData2 }) => {
  const [data, setData] = reactExports.useState({
    classData: ssrData2.class,
    levelData: ssrData2.levels,
    dataUserLogin: ssrData2.dataUserLogin,
    studentData: ssrData2.students
  });
