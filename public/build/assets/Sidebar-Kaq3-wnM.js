...
const ReportsComponent = ({ name }) => {
  return /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between border-b border-gray-200 py-2 px-4" }, /* @__PURE__ */ React.createElement("h1", { className: "text-lg font-medium text-gray-800" }, name), /* @__PURE__ */ React.createElement(
    "button",
    {
