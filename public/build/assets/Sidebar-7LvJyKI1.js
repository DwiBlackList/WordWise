...
const ReportsComponent = ({ name }) => {
  return /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between border-b border-gray-200 py-2 px-4" }, /* @__PURE__ */ React.createElement("h1", { className: "text-lg font-medium text-gray-800" }, name), /* @__PURE__ */ React.createElement("button", { className: "flex items-center gap-1 text-sm text-gray-600 hover:text-gray-800" }, /* @__PURE__ */ React.createElement(
    "svg",
    {
    ...
    /* @__PURE__ */ React.createElement("g", { id: "Interface / Download" }, /* @__PURE__ */ React.createElement(
      "path",
      {
        id: "Vector",
...
const Sidebar = ({ user }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    "div",
    {
      className: `flex flex-col top-0 left-0 ${isExpanded ? "w-56" : "w-16"} bg-white h-screen overflow-hidden transition-width duration-300`
    },
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between h-14 px-4" }, isExpanded && /* @__PURE__ */ React.createElement("img", { src: "logo.svg", alt: "logo", className: "h-8" }), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: toggleSidebar,
        className: "focus:outline-none"
      },
      isExpanded ? /* @__PURE__ */ React.createElement(PanelRightOpen, { className: "w-5 h-5" }) : /* @__PURE__ */ React.createElement(PanelRightClose, { className: "w-5 h-5 ml-2" })
    )),
    /* @__PURE__ */ React.createElement("div", { className: "overflow-x-hidden flex-grow" }, /* @__PURE__ */ React.createElement("ul", { className: "flex flex-col py-4 space-y-1" }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(
      "a",
      {
        href: "/home",
      ...
      /* @__PURE__ */ React.createElement(
        "span",
        {
          className: `inline-flex justify-center items-center ${isExpanded ? "ml-4" : "mx-auto"}`
        },
        /* @__PURE__ */ React.createElement(
          "svg",
          {
      ...
      /* @__PURE__ */ React.createElement(
        "span",
        {
          className: `ml-2 text-sm tracking-wide truncate ${!isExpanded && "hidden"}`
        },
        "Home"
      )
    ...
    )), (user == null ? void 0 : user.role) === "admins" ? /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(
      "a",
      {
        href: "/users",
        className: "relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500"
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex w-3/4 border-b border-gray-200 self-center" }, /* @__PURE__ */ React.createElement("br", null)),
    /* @__PURE__ */ React.createElement(
      "a",
      {
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center p-4" }, /* @__PURE__ */ React.createElement(
      "img",
      {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: `ml-3 ${!isExpanded && "hidden"}` }, /* @__PURE__ */ React.createElement("p", { className: "text-sm font-medium text-gray-800" }, user == null ? void 0 : user.name), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-500" }, user == null ? void 0 : user.email)))
  ));
};
export {
  Box as B,
  Grid2 as G,
  ReportsComponent as R,
  Sidebar as S
};
